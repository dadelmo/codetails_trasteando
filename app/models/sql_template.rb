class SqlTemplate < ActiveRecord::Base
  ...
  validates :format,  inclusion: Mime::SET.symbols.map(&:to_s) #["html", "text", "js", "css", "ics", "csv", "png", "jpeg", "gif", "bmp", "tiff", "mpeg", "xml", "rss", "atom", "yaml", "multipart_form", "url_encoded_form", "json", "pdf", "zip"]
  validates :locale,  inclusion: I18n.available_locales.map(&:to_s) #["en"]
  validates :handler, inclusion:
    ActionView::Template::Handlers.extensions.map(&:to_s) #["erb", "builder"]
